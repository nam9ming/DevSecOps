...
const ExecutionDetail = () => {
    ...
    const prettify = (name) => (name ? name.replace(/-/g, " ").replace(/\b\w/g, (c) => c.toUpperCase()) : "");
        ...
        <div className="p-6">
            <div className="bg-white shadow-md rounded-lg p-6 w-full max-w-4xl mx-auto mb-10">
                ...
                <div className="flex justify-end mt-6 pb-6">
                    <button onClick={handlePipelineClick} className="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white text-sm rounded-md shadow-sm">
                        Pipeline
                    </button>
                </div>
            </div>
